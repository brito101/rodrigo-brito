                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="status" required>
                                            <option
                                                {{ old('status') == 'post' ? 'selected' : ($post->status == 'post' ? 'selected' : '') }}
                                                value="post">Postado
                                            </option>
                                            <option
                                                {{ old('status') == 'draft' ? 'selected' : ($post->status == 'draft' ? 'selected' : '') }}
                                                value="draft">Rascunho
                                            </option>
                                            <option
                                                {{ old('status') == 'trash' ? 'selected' : ($post->status == 'trash' ? 'selected' : '') }}
                                                value="trash">Lixo
                                            </option>
                                        </x-adminlte-select2>
                                    </div>
