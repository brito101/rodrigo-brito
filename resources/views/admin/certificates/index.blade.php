...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-graduation-cap"></i> Certificados</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Certificados Cadastrados</h3>
                                @can('Criar Certificados')
                                    <a href="{{ route('admin.certificates.create') }}" title="Novo Certificado"
                                        class="btn btn-success"><i class="fas fa-fw fa-plus"></i>Novo Certificado</a>
                                @endcan
                            </div>
                        </div>
