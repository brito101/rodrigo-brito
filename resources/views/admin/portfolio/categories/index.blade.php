            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                ...
                                @can('Criar Categorias do Blog')
                                    <a href="{{ route('admin.portfolio-categories.create') }}" title="Nova Categoria"
                        ...
                        @php
                            $heads = [['label' => 'ID', 'width' => 10], ['label' => 'Imagem', 'no-export' => true], 'Título', 'Descrição', 'Postagens', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/portfolio-categories'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'cover', 'name' => 'cover', 'searchable' => false], ['data' => 'title', 'name' => 'title'], ['data' => 'description', 'name' => 'description'], ['data' => 'portfolios', 'name' => 'portfolios'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
