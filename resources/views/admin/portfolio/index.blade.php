...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-file"></i> Portfólio</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Projetos Cadastrados</h3>
                                @can('Criar Blog')
                                    <a href="{{ route('admin.portfolio.create') }}" title="Novo Projeto" class="btn btn-success"><i
                                            class="fas fa-fw fa-plus"></i>Novo Projeto</a>
                                @endcan
                            </div>
                        </div>
