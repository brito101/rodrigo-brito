                    ...
                    <div class="portfolio_articles fadeInScrool">
                        <article class="portfolio_article">
                            ...
                            <header>
                                ...
                                <h2><a title="Alfa Estágios"
                                        href="https://www.rodrigobrito.dev.br/portfolio/alfa-estagios">Alfa
                                        Estágios</a></h2>
...
@section('custom_js')
    <script src="https://www.rodrigobrito.dev.br/themes/web/assets/minify/home.js"></script>
@endsection
